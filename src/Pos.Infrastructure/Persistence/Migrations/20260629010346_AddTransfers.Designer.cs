...
namespace Pos.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260629010346_AddTransfers")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pos.Domain.Inventory.ReceivedTransfer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.HasIndex("TenantId", "StoreId", "TransferId")
                        .IsUnique()
                        .HasDatabaseName("ux_received_transfers");

                    b.ToTable("received_transfers", (string)null);
                });
